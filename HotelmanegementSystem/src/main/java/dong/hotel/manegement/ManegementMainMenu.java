...
public class ManegementMainMenu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setText("지정기간 점유율");

        jButton2.setText("객실 수입");

        jButton3.setText("ID 생성");

        jButton4.setText("예외보고서");

        jButton6.setText("보고서");

        jButton7.setText("이전");

        jButton8.setText("정보수정");

        jButton5.setText("예상 점유율");
