...
import dong.hotel.check.CheckOutInfomation;
...
public class Sfr300Process implements Fileinterface { // 체크인 관련 처리부 
    ...
    private ArrayList<CheckOutInfomation> checkout = new ArrayList<>();
    
    private String macosxroom = "/Users/nifskorea/Desktop/DB/"; 
private String windowsroom = "C:\\DB\\";
 private String macosxcheckout = "/Users/nifskorea/Desktop/DB/"; 
private String windowscheckout = "C:\\DB\\";
...
SFR100Process fileae = new SFR100Process();
    ...
    public void CSplite(){
        for(int i =0 ; i <readInfo.size(); i++){
           ...
           // roomstate.add(new CheckOutInformation(str[0], str[1], str[2], str[3], str[4], str[5], str[6]));
    }
    }
    @Override
    public void sPlite() {
...
public ArrayList<CheckOutInfomation> returnGuestInfo() throws IOException {
        return checkout;
    }
